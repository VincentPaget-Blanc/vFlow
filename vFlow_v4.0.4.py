...
# -*- coding: utf-8 -*-
"""
Flow Cytometry Visualization Tool - v4.0.4
@author: vincentpb
...
if __name__ == '__main__':
    try:
        ...
        _splash = _SplashScreen(version="4.0.4", total_steps=7)
    except Exception:
        _splash = None
    ...
    def _compute_and_plot(self):
        ...
        for lbl, df, color in samples:
            ...
            if dist_col and dist_col in df.columns:
                vals = df[dist_col].to_numpy(dtype=float, copy=False)[mask]
